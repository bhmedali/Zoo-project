...
//           System.out.println(myZoo.removeAnimal(dog));
        ...
        Aquatic aquaticTest = new Aquatic("Fish", "Sardine", 2, true, "Sea");
        Aquatic aquaticOne = new Aquatic("Fish", "bourri", 5, false, "Sea");
        Aquatic aquaticTwo = new Aquatic("Fish", "war9a", 4, false, "Sea");
        ...
        myZoo.addAquaticAnimal(aquaticOne);
        myZoo.addAquaticAnimal(aquaticTwo);
